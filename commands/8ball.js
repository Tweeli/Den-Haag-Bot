...
module.exports.run = async(bot, message, args) => {
    ...
    if(!message.channel.id == "560844017336582144" || !message.channel.id == "692811822809743380") return message.lineReply('Bot commands kunnen alleen in <#560844017336582144> uitgevoerd worden.');
